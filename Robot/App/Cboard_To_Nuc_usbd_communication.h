...
#define CMD_ID_CHASSIA_GIMBAL_ANGLE 0X16 // ���͵���������?�Ƕȣ���->�ϣ����ڱ�ר�ã�
...
typedef struct
{
	...
	bool_t defend_fortress; // �Ƿ�Ҫ�ط������ҷ����ݵĵ���
...
typedef struct
{
	...
	bool_t ready_catch_hero; // �Ƿ񵽴�ץӢ�۵ĵ�λ
...
extern uint8_t yaw_rotate_flag_last; // ��¼��һ�ε�yaw_rotate_flag�������жϵ�ǰ�ǲ��Ǹո��˳���ػ�ģʽ
// ��������
