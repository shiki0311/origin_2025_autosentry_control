...
//数据段长度，以字节为单位
#define LENGTH_AUTOAIM_DATA_RX		45			//接收自瞄数据（上→下）
#define LENGTH_move_cmd_DATA_RX    20      //接收整车控制数据（上->下）（哨兵专用）
...
#define LENGTH_REFEREE_DATA_TX		48			//发送决策需要的数据 2+2+1+1+2+2+2+4+14*2
//自瞄模式
